  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        ...
        >
          <div className="w-16 h-16 rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-500 flex items-center justify-center mb-4" aria-hidden="true">
            <WifiOff size={28} />
          </div>
...
export function OfflineBanner() {
  return (
    <div
      role="alert"
      aria-live="assertive"
      className="bg-amber-500 text-white text-center text-xs font-medium py-1.5 px-4"
    >
